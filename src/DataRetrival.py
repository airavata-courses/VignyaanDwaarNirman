...
connection = pika.BlockingConnection(pika.ConnectionParameters(host = 'rabbit' , port=35672, credentials=credentials))
...
def callback(ch, method, properties, body):
    ...
    microservice_connection = pika.BlockingConnection(pika.ConnectionParameters(host = 'rabbit' , port=35672, credentials=credentials))
