...
connection = pika.BlockingConnection(pika.ConnectionParameters(host = 'http://10.0.3.5' , port=35672, credentials=credentials))
...
def callback(ch, method, properties, body):
    ...
    microservice_connection = pika.BlockingConnection(pika.ConnectionParameters(host = 'http://10.0.3.5' , port=35672, credentials=credentials))
